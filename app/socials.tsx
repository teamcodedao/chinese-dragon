export default function Socials() {
  return (
    <div className='pt-5 flex gap-x-4 sm:*:multi-[w-[90px];px-2;py-2] *:multi-[aspect-square;w-[65px];px-1;py-1;rounded-2xl;bg-white;flex;items-center;justify-center] [&_img]:multi-[size-full]'>
